...
function __wbg_adapter_18(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1cc6f1f6194d14b9(arg0, arg1);
}
...
*/
export function loadRom(canvas_id, rom) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.loadRom(retptr, ptr0, len0, addHeapObject(rom));
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('turquoise_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
